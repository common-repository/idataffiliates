...
(function($){
    ...
    Tour.prototype.initPointer = function(){
        ...
        if ( ta_guided_tour_params.screenid == 'idatlink_page_idat-settings' ) {
    ...
    if ( ta_guided_tour_params.screenid === 'post' ) {
        ...
        $( 'body' ).on( 'ta_reinit_tour_pointer' , function() {
            ...
            setTimeout(function(){
                ...
                var $ta_button  = IDatLinkPicker.editorinit ? $( '.ta-add-link-button' ) : $( '#qt_content_idataffiliates_aff_link' ),
                    offset_top  = $ta_button.offset().top + 28,
                    offset_left = IDatLinkPicker.editorinit ? $ta_button.offset().left - 48 : $ta_button.offset().left - 23;
        ...
        $( '.wp-editor-tabs' ).on( 'click' , 'button' , function() {
            ...
            IDatLinkPicker.editorinit = $(this).hasClass( 'switch-tmce' ) ? true : false;
