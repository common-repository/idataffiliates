<?php
namespace IDatAffiliates\Helpers;
...
class Plugin_Constants {
    ...
    */
    ...
    const VERSION             = '1.0.0';
    const TEXT_DOMAIN         = 'idataffiliates';
    const THEME_TEMPLATE_PATH = 'idataffiliates';
    const META_DATA_PREFIX    = '_ta_';

    // CPT Taxonomy constants
    const AFFILIATE_LINKS_CPT   = 'idatlink';
    const AFFILIATE_LINKS_TAX   = 'idatlink-category';
    ...
    // DB Tables
    const LINK_CLICK_DB      = 'idata_link_clicks';
    const LINK_CLICK_META_DB = 'idata_link_clicks_meta';
    ...
    */
    ...
    public function __construct( Abstract_Main_Plugin_Class $main_plugin ) {
        ...
        // Path constants
        $this->_MAIN_PLUGIN_FILE_PATH = WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'idataffiliates' . DIRECTORY_SEPARATOR . 'idataffiliates.php';
        ...
        $this->_REDIRECT_TYPES        = apply_filters( 'ta_redirect_types' , array(
            '301' => __( '301 Permanent' , 'idataffiliates' ),
            '302' => __( '302 Temporary' , 'idataffiliates' ),
            '307' => __( '307 Temporary (alternative)' , 'idataffiliates' )
        ) );
